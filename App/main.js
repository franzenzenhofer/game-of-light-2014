...
(function() {
  ...
  init = function(w) {
    var currently_active_commands, game, getActiveCommands, removeActiveCommand, setActiveCommand, world_height, world_width;
    dlog('in init');
    ...
    game = function(w, max_nr_of_enemies, chance_of_new_enemy, min_enemy_speed, max_enemy_speed, number_of_active_players) {
      ...
      run = function() {
        var bubbles, continue_game, loop_id, _ref;
        window.stats.begin();
