...
(function() {
  ...
  init = function(w, full_screen) {
    var currently_active_commands, dom_window, game, getActiveCommands, loop_id, ngui, nwin, removeActiveCommand, setActiveCommand, world_height, world_width;
    if (w == null) {
    ...
    game = function(w, max_nr_of_enemies, chance_of_new_enemy, min_enemy_speed, max_enemy_speed, number_of_active_players) {
      var bullets, cache_canvas, cctx, draw, enemies, explodeBubble, explosions, fireBulletBy, joinBubbles, movePlayer, players, run, update, wctx, _JUST_FIRED_A_BULLET_;
